...
const programs = [
  {
    ...
    requirements: [
      "具备微电子、物理、光学、计算机、人工智能、电子和材料等专业博士学位，35 周岁以下，毕业不超过 3 年。",
      "有进取心，具有严谨科学态度，能够全职从事博士后研究工作。",
      "毕业于 211 高校及中科院体系者优先。"
    ],
    directions: ["光谱编码薄膜及微结构研究", "光电探测器及光谱芯片研究", "微型光谱仪器及算法应用"],
    notes: "在站两年，年薪不低于 36 万，额外叠加实验室补充津贴；应届毕业生可申领相关免税补贴；出站留杭工作可按政策申请补助和杭州市人才认定。"
  },
  {
    title: "交流博士生项目",
    audience: "在读优秀博士生",
    ...
    requirements: [
      "在读优秀博士生，已完成基础课程学习。",
      "征得校方及导师同意，来院实习期不少于一年半。",
      "微电子、光学工程、电子信息、物理、材料、计算机、人工智能等专业。"
    ],
    directions: ["光谱编码薄膜及微结构研究", "光电探测器及光谱芯片研究", "微型光谱仪器及算法应用"],
    notes: "光学结构设计、算法、电路设计可远程；可报销往返交通费；部分科研成果以原单位为第一单位，原单位导师为通讯作者。"
  },
  {
    title: "优秀研究生（夏令营）招生",
    audience: "保研/直博/考研学生",
    stipend: "平均 3K/月 + 奖励 + 绿色通道",
    requirements: [
      "微电子、光学工程、电子信息、物理、材料、计算机、人工智能等专业。",
      "品学兼优，保研学生优先。",
      "对光谱芯片、光谱仪器或光谱算法方向有持续科研兴趣。"
    ],
    directions: ["微电子与固体电子学（光谱芯片）", "光电工程（光谱仪器）", "人工智能（光谱算法）"],
    notes: "研究生平均每月 3K+ 奖励；实验室提供完善培训体系、充足科研经费和升学杭高院绿色护航通道。"
  },
  {
    title: "本科实习生项目",
    audience: "优秀本科生",
    stipend: "1-2K/月 + 奖励 + 读研绿色通道",
    requirements: [
      "杭州市内重点高校大三在校学生优先。",
      "微电子、物理、光学、计算机、人工智能、电子和材料等专业，学习成绩优秀，读研意志坚定。",
      "积极主动，做事可靠，每周至少可实习两天，寒暑假可实习。"
    ],
    directions: ["微电子与固体电子学（光谱芯片）", "光电工程（光谱仪器）", "人工智能（光谱算法）"],
    notes: "在校实习生助学金约 1000 元/月 + 奖励；毕业实习生助学金约 2000 元/月 + 奖励；可按情况报销往返交通费。"
  }
];
